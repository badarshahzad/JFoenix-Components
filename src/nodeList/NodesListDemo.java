...
public class NodesListDemo extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		try {
			...
			main.setMinHeight(30);
			main.setMaxHeight(50);
			main.setSpacing(10);
			main.getChildren().addAll(button1,button2,button3);
			
			if(transition.getRate()==1){
				
				borderPaneRoot.setTop(main);
				main.setVisible(true);
			}
			else{
				borderPaneRoot.setTop(null);
			...
			*/
			...
			scene.getStylesheets().add(NodesListDemo.class.getResource("jfoenix-components.css").toExternalForm());
